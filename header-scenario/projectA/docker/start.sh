...
JAVA_OPTS="$JAVA_OPTS -Dskywalking.agent.service_name=projectA"

JAVA_OPTS="$JAVA_OPTS -Durl.prefix=http://${PROJECTB_URL}/projectB"

java $JAVA_OPTS -jar /usr/local/header-scenario/projectA.jar