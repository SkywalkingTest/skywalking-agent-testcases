...
export AGENT_FILE_PATH=/usr/local/apm-toolkit-trace-scenario/agent
...
java ${RESTTEMPLATE_CASE_OPTS} -jar /usr/local/apm-toolkit-trace-scenario/apm-toolkit-trace-scenario.jar
