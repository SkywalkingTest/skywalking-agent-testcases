...
$JAVA_HOME/bin/java $JAVA_OPTS $SERVICECOMB_PROVIDER_OPTS -classpath "$CLASSPATH"  org.apache.skywaking.apm.testcase.servicecomb.provider.CodeFirstProviderMain
