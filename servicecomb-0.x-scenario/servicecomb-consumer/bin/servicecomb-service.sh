...
$JAVA_HOME/bin/java $JAVA_OPTS $SERVICECOMB_CONSUMER_OPTS  -classpath "$CLASSPATH" org.apache.skywaking.apm.testcase.servicecomb.consumer.CodeFirstConsumerMain
