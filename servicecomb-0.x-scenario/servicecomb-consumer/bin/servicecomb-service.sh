...
$JAVA_HOME/bin/java $JAVA_OPTS -classpath "$CLASSPATH" $SERVICECOMB_CONSUMER_OPTS org.apache.skywaking.apm.testcase.servicecomb.consumer.CodeFirstConsumerMain
