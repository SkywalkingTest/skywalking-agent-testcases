...
export AGENT_FILE_PATH=/usr/local/resteasy-server-scenario/agent
...
RESTEASY_PORT=${RESTEASY_PORT} java $SCENARIO_OPTS -jar /usr/local/resteasy-server-scenario/resteasy-server-scenario.jar